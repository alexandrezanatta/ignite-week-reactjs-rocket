...
export type GetLessonBySlugQuery = { __typename?: 'Query', lesson?: { __typename?: 'Lesson', title: string, id: string, slug: string, description?: string | null, videoId: string, teacher?: { __typename?: 'Teacher', bio: string, avatarURL: string, name: string } | null } | null };

export type GetLessonsQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type GetLessonsQueryQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', id: string, title: string, lessonType: LessonType, availableAt?: any | null, slug: string }> };
